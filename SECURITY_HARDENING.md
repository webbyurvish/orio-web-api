...
- **Security note**: exposing Swagger publicly in production increases attack surface (endpoint discovery). Consider re-enabling protection (auth + IP allowlist) before going live.
